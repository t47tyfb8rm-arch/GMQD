...
VERSION_TO = "20260728-v1-detail-payment-value-right"


CSS_PATCH = """
        /* github patch: detail payment value right */
        .detail-modal .payment-detail-row .detail-value,
        .detail-modal .detail-payment-only .detail-value {
            text-align: right !important;
            justify-self: end !important;
        }
        .detail-modal .payment-detail-row .payment-breakdown,
        .detail-modal .detail-payment-only .payment-breakdown {
...
def main() -> None:
    ...
    if "github patch: detail payment value right" not in html:
