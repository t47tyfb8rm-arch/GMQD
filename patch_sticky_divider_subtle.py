...
VERSION_TO = "20260729-v1-sticky-divider-subtle"


CSS_PATCH = """
        /* github patch: sticky divider subtle */
        .tab-bar {
            border-bottom-color: rgba(234, 211, 220, 0.16) !important;
            box-shadow: 0 8px 18px rgba(92, 52, 70, 0.025) !important;
        }
        body.dark .tab-bar {
            border-bottom-color: rgba(82, 66, 77, 0.22) !important;
...
def main() -> None:
    ...
    if "github patch: sticky divider subtle" not in html:
