...
VERSION_TO = "20260729-v1-card-status-top-center-small"


CSS_PATCH = """
        /* github patch: card status top center small */
        .product-card .img-wrap .tag {
            ...
            background: rgba(255, 105, 180, 0.72) !important;
            color: rgba(255, 255, 255, 0.96) !important;
            box-shadow: 0 2px 8px rgba(255, 105, 180, 0.14) !important;
            backdrop-filter: blur(6px);
            -webkit-backdrop-filter: blur(6px);
        }
        body.dark .product-card .img-wrap .tag {
            background: rgba(255, 139, 200, 0.68) !important;
            color: rgba(255, 255, 255, 0.96) !important;
...
def main() -> None:
    ...
    if "github patch: card status top center small" not in html:
