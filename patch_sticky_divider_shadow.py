...
VERSION_TO = "20260729-v1-sticky-divider-shadow"


CSS_PATCH = """
        /* github patch: sticky divider shadow */
        .tab-bar {
            border-bottom: 1px solid rgba(222, 186, 199, 0.86) !important;
            box-shadow: 0 8px 16px rgba(92, 52, 70, 0.08) !important;
        }
        body.dark .tab-bar {
            border-bottom-color: rgba(92, 71, 84, 0.95) !important;
...
def main() -> None:
    ...
    if "github patch: sticky divider shadow" not in html:
