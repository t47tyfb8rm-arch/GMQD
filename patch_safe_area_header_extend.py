...
VERSION_TO = "20260730-v1-safe-area-header-extend"
...
CSS_PATCH = """
        ...
        .tab-bar {
            top: var(--sticky-header-height, 76px) !important;
        }
...
def main() -> None:
    ...
    for old_version in (
        "20260730-v1-ios-safe-area-like-fund",
    ...
    if "github patch: safe area header extend" not in html:
